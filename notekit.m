// AUTO-GENERATED by generate-notes-cli.py — do not edit manually
...
static void usage(void) {
    ...
    fprintf(stderr, "  notekit get <title> [--folder <name>]\n");
    fprintf(stderr, "  notekit read <title> [--folder <name>]\n");
    fprintf(stderr, "  notekit read-attrs <title> [--folder <name>]\n");
    fprintf(stderr, "  notekit create-empty --folder <name>\n");
    fprintf(stderr, "  notekit delete <title> [--folder <name>]\n");
    fprintf(stderr, "  notekit append <title> <text> [--folder <name>]\n");
    fprintf(stderr, "  notekit insert <title> <text> --position <n> [--folder <name>]\n");
    fprintf(stderr, "  notekit delete-range <title> --start <n> --length <n> [--folder <name>]\n");
    fprintf(stderr, "  notekit set-attr <title> --offset <n> --length <n> [--style <n>] [--indent <n>] [--todo-done true|false] [--folder <name>]\n");
    fprintf(stderr, "  notekit move <title> --folder <from> --to <to-folder>\n");
    fprintf(stderr, "  notekit create-folder <name>\n");
    fprintf(stderr, "  notekit delete-folder <name>\n");
    fprintf(stderr, "  notekit search <query> [--folder <name>]\n");
    fprintf(stderr, "  notekit pin <title> [--folder <name>]\n");
    fprintf(stderr, "  notekit unpin <title> [--folder <name>]\n");
    fprintf(stderr, "\n  Convenience (composed from primitives):\n");
    fprintf(stderr, "  notekit replace <title> --search <text> --replacement <text> [--folder <name>]\n");
    fprintf(stderr, "  notekit read-structured <title> [--folder <name>]\n");
    fprintf(stderr, "  notekit duplicate <title> [--folder <name>] [--title <new-title>]\n");
    fprintf(stderr, "  notekit delete-line <title> <search-text> [--folder <name>]\n");
    fprintf(stderr, "\n  Testing:\n");
