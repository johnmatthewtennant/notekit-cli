#!/usr/bin/env python3
"""
Generate notes-cli-v2.m from NotesShared private API.

USAGE:
    python3 generate-notes-cli.py > notes-cli-v2.m
    # Then: make notes-cli-v2

MAINTENANCE:
    Same pattern as generate-cli.py for reminders. This generator produces
    notes-cli-v2.m — an Objective-C CLI wrapping Apple's private NotesShared
    framework. One-to-one mapping with the underlying API.

    To add a new READ property:
        1. Add to NOTE_READ_PROPS below
        2. Regenerate: python3 generate-notes-cli.py > notes-cli-v2.m && make notes-cli-v2
    ...
    Architecture:
        ...
        generate-notes-cli.py → generates notes-cli-v2.m (this file)
        notes-cli-v2.m        → AUTO-GENERATED, do not edit manually
"""
...
// Regenerate: python3 generate-notes-cli.py > notes-cli-v2.m && make notes-cli-v2
